...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function handleDeleteButton() {
        ...
        } else if (type === "remote" && window.RemoteModule && RemoteModule.deleteButton) {
            deleted = RemoteModule.deleteButton(id)
        } else if (type === "lock" && window.LockModule && LockModule.deleteButton) {
            deleted = LockModule.deleteButton(id)
        } else if (type === "curtain" && window.CurtainModule && CurtainModule.deleteButton) {
            deleted = CurtainModule.deleteButton(id)
    ...
    function init() {
        ...
        let DimmerModule, CCTModule, RGBModule, LockModule, CurtainModule, RemoteModule
