...
function getSeriesCode(productKey) {
    ...
    if (productKey === 'EQUIPMENTS') return 'EQ'; // Add this line
        ...
        <div class="mark-controls-box" id="networkDBControls" style="margin-top: 20px; border-color: #9C27B0;">
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       class="form-control" 
                       placeholder="Enter brand name (e.g., Cisco, TP-Link)"
                       value="${data.brand || ''}"
...
function populateModal(mark) {
    ...
    if (mark.isDBBox) {
        ...
        // In the populateModal function, update the switch section:
    } else if (mark.isSwitchFamily) {
        // Create HTML elements for separate points/lines
        const typeEl = document.createElement('div');
...
function enhanceProductDataWithBrands() {
    const brands = {
        ...
        "EQUIPMENTS": "Equipment", // Added equipment brand
